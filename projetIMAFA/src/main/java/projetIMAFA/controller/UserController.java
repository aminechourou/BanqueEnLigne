...
import projetIMAFA.entity.Geographical_area;
import projetIMAFA.entity.Role_User;
import projetIMAFA.entity.Status;
import projetIMAFA.entity.User;
import projetIMAFA.service.IUserService;
...
public void setVar(int var) {
	...
	public String doLogin(){
		...
		User u=userService.getcode(this.getEmail());
		//if (email.length()>=8 && password.length()>=8)
		//{
			//this.setIm(u.getImage());
			encoder.matches(password, u.getPassword());

		if(u.getRole_User() == projetIMAFA.entity.Role_User.ROLE_CLIENT && encoder.matches(password, u.getPassword()))
			{
						if(u.getVerified_account() == 1){
							...
							FacesMessage facesMessage =
								...
								new FacesMessage("Login Failed: you need to verify your email ");
			...
			else if (u.getRole_User() == projetIMAFA.entity.Role_User.ROLE_RESPONSABLEFINANCIER && encoder.matches(password, u.getPassword())){
				navigateTo ="/emp/listeDemandeContratNT.xhtml?faces-redirect=true";
			}
	...
	*/
    ...
    public String addUser() throws MessagingException{
    		System.out.println(this.getPassword()+"  "+this.getConfirm_password() +  "     " + this.getCin()  +  "     " + this.getNumber() + "     " + this.getEmail());
    	if(this.getPassword().equals(this.getConfirm_password()))
    	{
    	  	User u=userService.getcode(this.getEmail());
	    	Date currentUtilDate = new Date();
	    	Random rand = new Random();
	    	String crypt=passcrypt.encode(this.getPassword());
    	if(u==null)
    	{
    	if(this.getMotorisation()==true)
    	{
    		if(this.getShifting()==true)
    		{
    			if(this.getSexe().equals("homme"))
    			{
    		    	userService.addUser(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),1,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    		    			1,this.getEmail(),crypt,this.getConfirm_password(),"1.png",rand.nextInt(9999999)+1111111,
    		    			currentUtilDate,projetIMAFA.entity.Role_User.ROLE_CLIENT));
    		    	
    		    	notificationService.sendEmailVerify(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),0,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    		    			1,this.getEmail(),crypt,this.getConfirm_password(),"1.png",rand.nextInt(9999999)+1111111,
    		    			currentUtilDate,projetIMAFA.entity.Role_User.ROLE_CLIENT));
    		    	return "login.jsf?faces-redirect=true";
    			 	...
    			 	userService.addUser(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),1,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    		    			1,this.getEmail(),crypt,this.getConfirm_password(),"2.png",rand.nextInt(9999999)+1111111,
    		    			currentUtilDate,projetIMAFA.entity.Role_User.ROLE_CLIENT));	
    		    	notificationService.sendEmailVerify(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),0,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    			...
    			if(sexe.equals("homme"))
    			{
    				userService.addUser(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),1,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    		    			0,this.getEmail(),crypt,this.getConfirm_password(),"1.png",rand.nextInt(9999999)+1111111,
    		    			currentUtilDate,projetIMAFA.entity.Role_User.ROLE_CLIENT));
    				...
    				userService.addUser(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),1,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
    		    			0,this.getEmail(),crypt,this.getConfirm_password(),"2.png",rand.nextInt(9999999)+1111111,
    		    			currentUtilDate,projetIMAFA.entity.Role_User.ROLE_CLIENT));	
    		    	notificationService.sendEmailVerify(new User(this.getFirst_name(),this.getLast_name(),this.getNumber(),this.getCin(),
    		    			this.getGeographical_area(),0,this.getBirth_date(),
    		    			this.getAddress(),this.getPostal_code(),this.getJob(),this.getStatus(),this.getSexe(),
